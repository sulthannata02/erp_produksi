...
@section('page-sub', 'Status seluruh proses produksi')
...
<div class="card">
    {{-- Filter --}}
    <form method="GET" action="{{ route('tracking.index') }}" id="form-filter-tracking">
        <div class="filter-bar">
            <input type="date" name="tanggal" class="form-select" id="filter-tanggal-tracking"
                   value="{{ request('tanggal') }}">

            <div class="search-box">
                <input type="text" name="search" id="search-tracking"
                       placeholder="Cari kode, material, customer..."
                       value="{{ request('search') }}">
                <i class="ph ph-magnifying-glass search-icon"></i>
            </div>

            <button type="submit" class="btn btn-primary btn-sm" id="btn-filter-tracking">
                <i class="ph ph-funnel"></i> Filter
            </button>

            @if(request()->hasAny(['search','tanggal']))
                <a href="{{ route('tracking.index') }}" class="btn btn-secondary btn-sm">Reset</a>
            @endif
        </div>
    </form>
